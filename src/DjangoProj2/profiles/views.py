...
class ProfileDetailView(DetailView):
	...
	def get_context_data(self, *args, **kwargs):
		...
		qs = Bars_Location_Model.objects.filter(owner=user).search(query) #(owner=self.get_object())
		# if query:
		# 	#print(query.upper())
		# 	#qs = Bars_Location_Model.objects.search(query)
		#  	qs = qs.filter(name__icontains=query)
		# else:
		# 	qs = Bars_Location_Model.objects.filter(owner=user)
