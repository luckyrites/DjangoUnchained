...
class Profile(models.Model):
	...
	def send_activation_email(self):
		...
		if not self.activated:
			self.activation_key = code_generator()#"somekey" # generate key here
			self.save()
			# path_ = reverse
			...
			recipient_list = [self.user.email] #['mytest@gmail.com', 'you@email.com']
...
def post_save_user_receiver(sender, instance, created, *args, **kwargs):
	if created:
		...
		default_user_profile = Profile.objects.get_or_create(user__id=1)[0] #user will be followed by default
